...
public class AddNewBO extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_bo);
                ...
                public void onClick(View v) {
                    if (validate() != false) {
                        ...
                        if (resNum==412) {
                            ...
                            CharSequence text = responseResult;
                            ...
                            register2.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Intent intent = new Intent(AddNewBO.this, org.ruppin.roper.login_page.loginPage.class);
    ...
    class BackgroundTaskPost extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            json_url = "http://"+IP_ADD+":8080/WebService/webapi/business_owner_service/businessOwner";
        }
        @Override
        protected String doInBackground(Void... voids) {
            try {
                try {
                    ...
                    {
                        resNum = 412;
                        responseResult = conn.getHeaderField("Information");
                        conn.disconnect();
                    }
                    else
                    {
