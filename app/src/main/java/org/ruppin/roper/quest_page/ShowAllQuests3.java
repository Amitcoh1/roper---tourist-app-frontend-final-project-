...
public class ShowAllQuests3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_all_quests3);
        this.activity = this;
        IP_ADD = getResources().getString(R.string.IP);
        showAll = (Spinner) findViewById(R.id.showAllQuestsSpinner3);
        next = (Button)findViewById(R.id.moveToNextPage3);
                    ...
                    public void onClick(View v) {
                        ...
                        call.enqueue(new Callback<questNoBS>() {
                            ...
                            public void onResponse(Call<questNoBS> call, Response<questNoBS> response) {
                                ...
                                Intent intent = new Intent(ShowAllQuests3.this, ShowAllMissions.class);
