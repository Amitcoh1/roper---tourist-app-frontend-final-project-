...
public class ShowAllQuestsToRemoveBsns extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_all_quests5);
        this.activity = this;
        IP_ADD = getResources().getString(R.string.IP);
        showAll = (Spinner) findViewById(R.id.showAllQuestsSpinner5);
        next = (Button)findViewById(R.id.moveToNextPage5);
                    ...
                    public void onClick(View v) {
                        ...
                        call.enqueue(new Callback<questNoBS>() {
                            ...
                            public void onResponse(Call<questNoBS> call, Response<questNoBS> response) {
                                ...
                                Intent intent = new Intent(ShowAllQuestsToRemoveBsns.this, ShowAllMissionsToRemoveBsns.class);
