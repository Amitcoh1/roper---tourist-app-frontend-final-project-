...
public class ShowAllQuests2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_all_quests2);
        this.activity = this;
        IP_ADD = getResources().getString(R.string.IP);
        showAll = (Spinner) findViewById(R.id.showAllQuestsSpinner2);
        next = (Button)findViewById(R.id.moveToNextPage2);
            ...
            public void onResponse(Call<ArrayList<Quest>> call, Response<ArrayList<Quest>> response) {
                ...
                next.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Retrofit retrofit  = Utils.retrofitInit(String.format("http://"+IP_ADD+":8080/WebService/webapi/"),userName,userPass);
                        jsonQuestPlaceHolder  = retrofit.create(JsonQuestPlaceHolder.class);
                        Call call = jsonQuestPlaceHolder.getQuest("http://"+IP_ADD+":8080/WebService/webapi/quest_service/quest?name="+showAll.getSelectedItem().toString());
                        call.enqueue(new Callback<Quest>() {
                            @Override
                            public void onResponse(Call<Quest> call, Response<Quest> response) {
                                Intent intent = new Intent(ShowAllQuests2.this, AddMission.class);
