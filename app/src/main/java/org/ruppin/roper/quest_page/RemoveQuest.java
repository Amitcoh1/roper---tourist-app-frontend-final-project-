...
public class RemoveQuest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.remove_quest_activity);
        this.activity = this;
        IP_ADD = getResources().getString(R.string.IP);
        showAll = (Spinner) findViewById(R.id.showAllQuestsSpinnerToRemove);
        remove = (Button)findViewById(R.id.removeQuest);
        //
