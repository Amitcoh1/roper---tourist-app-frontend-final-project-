...
public class ShowAllQuests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_all_quests_activity);
        this.activity = this;
        IP_ADD = getResources().getString(R.string.IP);
        showAll = (Spinner) findViewById(R.id.showAllQuestsSpinner);
        next = (Button)findViewById(R.id.moveToNextPage);
            ...
            public void onResponse(Call<ArrayList<Quest>> call, Response<ArrayList<Quest>> response) {
                ...
                next.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(ShowAllQuests.this, EditQuest.class);
